const blackCards = [
        ...
        const whiteCards = [
            "Um anão zangado.", "Adaga que vinha dentro do boneco do Fofão", "Anões Hermafroditas", "Incesto", "Contos Eróticos em Braile", "Ansiedade", "O som do silêncio, mas com mais peidos.", "Apropriação cultural.", "Chorar no autocarro.", "O capitalismo tardio.", "Uma crise existencial na secção de cereais.", "Gentrificação.", "Fingir que se percebe de vinhos.", "O inevitável avanço da morte.", "Um golpe de estado.", "Privilégio branco.", "Monarquia", "Meu rabo.", "Um coach de vida desempregado.", "Bacon. A resposta é sempre bacon.", "Dizer 'você também' ao empregado do cinema.", "A minha total falta de vontade de viver.", "Um pombo a julgar as tuas escolhas de vida.", "Debates acesos sobre ananás na pizza.", "Opiniões não solicitadas sobre CrossFit.", "Aquele email que começa com 'Espero que este email o encontre bem'.", "Explicar memes a pessoas mais velhas.", "Um gato a planear a dominação mundial.", "Impostos.", "Não ter dinheiro para o psicólogo."
        ];
